...
// configuration step. It creates a namespace called `nmea_sim`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", nmea_sim::cmake::project_name, nmea_sim::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", nmea_sim::cmake::project_version);
      return EXIT_SUCCESS;
    }
